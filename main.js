...
function enterLoader() {
  ...
  //   let words = SplitParent.words; //an array of all the divs that wrap each character
    let SplitClient = new SplitText('.loader-text', { type: 'chars', charsClass: "loaderParent" });
    let SplitParent = new SplitText('.loader-text', { type: 'chars', charsClass: "loaderChild" });
...
function setupProjectCard() {
  ...
  targets.forEach((target) => {
    let SplitClient = new SplitText(target, { type: "words", wordsClass: "lineParent" });
    let SplitParent = new SplitText(target, { type: 'words', wordsClass: "lineChild" });
    let words = SplitParent.words; //an array of all the divs that wrap each character
    gsap.from(words, {
      duration: 1,
      y: 50,
...
function setupSplitsParagraph() {
  ...
  targets.forEach((target) => {
    let SplitClient = new SplitText(target, { type: 'lines', linesClass: "lineChild" });
    let SplitParent = new SplitText(target, { type: "lines", linesClass: "lineParent" });
...
function setupSplitsTitle() {
  ...
  targets.forEach((target) => {
    let SplitParent = new SplitText(target, { type: "words", wordsClass: "wordParent" });
    let SplitClient = new SplitText(target, { type: 'words', wordsClass: "wordChild" });
...
function davide() {
  ...
  targets.forEach((target) => {
    let SplitParent = new SplitText(target, { type: "words", wordsClass: "wordParent" });
    let SplitClient2 = new SplitText(target, { type: 'words', wordsClass: "wordChild" });
...
function showNav() {
    let SplitParent = new SplitText(".nav-link", { type: "words", wordsClass: "wordParent" });
    let SplitClient = new SplitText(".nav-link", { type: 'words', wordsClass: "wordChild" });
    let words = SplitClient.words; //an array of all the divs that wrap each character
...
function upSplit() {
  ...
  targets.forEach((target) => {
    let SplitParent = new SplitText(target, { type: "lines", linesClass: "brushChild" });
    let SplitClient2 = new SplitText(target, { type: 'lines', linesClass: "brushParent" });
    let words = SplitClient2.lines; //an array of all the divs that wrap each character
